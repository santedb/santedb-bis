...
namespace SanteDB.BI.Model
{
    ...
    /// <summary>
    /// Execute an arbitrary SQL flow in the pipeline
    /// </summary>
    [XmlType(nameof(BiDataFlowSqlStep), Namespace = BiConstants.XmlNamespace)]
    [JsonObject]
    [ExcludeFromCodeCoverage] // Serialization class
    public class BiDataFlowSqlStep : BiDataFlowStep, IDataFlowStreamStepDefinition
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public BiDataFlowStep InputStep => this.InputConnection?.Resolved as BiDataFlowConnectionStep;
