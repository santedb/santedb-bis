...
namespace SanteDB.BI.Datamart
{
    ...
    public interface IDataIntegratorVariableProvider
    {
        ...
        /// <summary>
        /// Attempt to retrieve <paramref name="variableName"/> from the variable provider
        /// </summary>
        /// <param name="variableName">The name of the variable to retrieve</param>
        /// <param name="value">The value of the variable</param>
        /// <returns>True if the variable was retrieved</returns>
        bool TryGetVariable(string variableName, out dynamic value);
    }
}